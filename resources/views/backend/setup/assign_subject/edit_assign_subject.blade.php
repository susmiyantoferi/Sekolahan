                       ...
                       <form method="POST" action=" {{ route('update.assign.subject', $editData[0]->class_id) }}">
                        ...
                        <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="subject_id[]"  required="" class="form-control">
                                                <option value="" selected="" disabled="" >Select School Subject</option>
                           ...
                           <div class="text-xs-right">
                               ...
                               <a href="/setup/assign/subject/view" class="btn btn-rounded btn-primary mb-5">Back</a>
                           </div>
                       </form>
