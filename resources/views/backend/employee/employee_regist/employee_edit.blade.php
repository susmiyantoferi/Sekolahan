                              ...
                              <div class="col-md-4">
                               ...
                               <div class="col-md-4">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" name="f_name" class="form-control" required="" value="{{ $editData->f_name }}">
                                  </div>
                                </div>
                               ...
                               <div class="col-md-4">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" name="m_name" class="form-control" required="" value="{{ $editData->m_name }}">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="controls">
                                      ...
                                      <select name="religion" id="religion" required="" class="form-control">
                                          ...
                                          <option value="Kristen" {{ ($editData->religion == 'Kristen')? 'selected': '' }}>Kristen</option>
