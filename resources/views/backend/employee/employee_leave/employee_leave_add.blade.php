                        ...
                        @csrf
                         <div class="row">
                                ...
                                <div class="col-md-6"> {{-- firt col-md-6 --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input style="display: none;" type="text" name="name" id="add_another" class="form-control" placeholder="Write New Purpose">
                           ...
                           <div class="text-xs-right">
                               ...
                               <a href="/employees/leave/employee/view" class="btn btn-rounded btn-primary mb-5">Back</a>
                           </div>
                       </form>
